<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="WebAppServerControls.Home" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table class="auto-style1">
                <tr>
                    <td colspan="4"><h2>Home Page</h2></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="auto-style2">
                        <asp:Image ID="Image2" runat="server" ImageUrl="~/Images/p2.jpg" />
                    </td>
                    <td class="auto-style3">
                        <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/p1.jpg" />
                    </td>
                    <td colspan="2">
                        <asp:Image ID="Image3" runat="server" ImageUrl="~/Images/p3.jpg" />
                    </td>
                </tr>
            </table>
        </div>
